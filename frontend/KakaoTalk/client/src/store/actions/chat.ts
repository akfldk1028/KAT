...
export interface UpdateChatMessageAction {
  type: ChatTypes.UPDATE_CHAT_MESSAGE;
...
// 채팅 메시지 업데이트 (시크릿 변환 등)
export const updateChatMessage = (param: UpdateChatMessageDto): UpdateChatMessageAction => ({
  type: ChatTypes.UPDATE_CHAT_MESSAGE,
  payload: param
});
